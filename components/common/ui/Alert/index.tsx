...
const AlertDialogOverlay = ({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/30 data-[state=open]:animate-in",
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          "translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[20px]",
          "border-2 border-border p-6 duration-200 sm:max-w-lg",
          className,
        )}
        {...props}
      />
