...
const DrawerOverlay = ({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "bg-black/30 data-[state=open]:animate-in data-[state=closed]:animate-out",
    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=top]:rounded-b-base border-t-2 border-t-border",
          "data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0",
          "data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[80vh]",
          "data-[vaul-drawer-direction=bottom]:rounded-t-base border-b-2 border-b-border",
      ...
      >
        <div 
          className={cn(
            ...
            "group-data-[vaul-drawer-direction=bottom]/drawer-content:block bg-current"
          )} 
        />
        {children}
      </DrawerPrimitive.Content>
