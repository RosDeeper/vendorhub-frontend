...
const DialogOverlay = ({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "fixed bg-black/30 inset-0 z-50 data-[state=open]:animate-in",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)]",
          "translate-x-[-50%] translate-y-[-50%] gap-4 rounded-base border-2",
          "border-border p-6 shadow-shadow duration-200 sm:max-w-lg",
          'p-5!',
          className,
        )}
        {...props}
      >
        ...
        <DialogPrimitive.Close 
          className={cn("absolute right-4 top-4 rounded-base opacity-100 ring-offset-white",
